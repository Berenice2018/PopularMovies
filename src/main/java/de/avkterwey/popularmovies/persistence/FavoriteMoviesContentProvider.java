...
/*
 * Created by Berenice on 03.05.18.
 */
...
public class FavoriteMoviesContentProvider extends ContentProvider {
    ...
    public final static int FAVORITE_MOVIES = 100; // directory
    public final static int FAVORITE_MOVIE_WITH_ID = 101; // single item
    ...
    public static UriMatcher buildUriMatcher(){
        ...
        uriMatcher.addURI(FavoriteMoviesContract.AUTHORITY,
                FavoriteMoviesContract.FAVORITES_PATH,
                FAVORITE_MOVIES);
    ...
    public Cursor query(@NonNull Uri uri, @Nullable String[] projection, @Nullable String selection,
        ...
        switch(match){
            case FAVORITE_MOVIES:
                returnedCursor = db.query(FavoriteMoviesContract.FavoriteMoviesEntry.TABLE_NAME,
    ...
    public String getType(@NonNull Uri uri) {
        throw new UnsupportedOperationException("FavoriteMoviesContentProvider.getType() Not implemented");
    }
    ...
    public Uri insert(@NonNull Uri uri, @Nullable ContentValues values) {
        ...
        switch(match){
            case FAVORITE_MOVIES:
                long id = db.insert(FavoriteMoviesContract.FavoriteMoviesEntry.TABLE_NAME,
                        null,
                        values);
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues values, @Nullable String selection, @Nullable String[] selectionArgs) {
        throw new UnsupportedOperationException("FavoriteMoviesContentProvider.Update() Not implemented");
    }
}
